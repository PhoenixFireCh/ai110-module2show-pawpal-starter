from pawpal_system import Priority, Recurrence, TimeWindow, Pet, Owner, Task, Schedule, Account

from dataclasses import dataclass, field
from datetime import date, datetime, time
from enum import Enum

acc = Account(Owner("Harrison", TimeWindow(time(6, 00), time(20, 45))))
...
acc.create_schedule().print_plan()